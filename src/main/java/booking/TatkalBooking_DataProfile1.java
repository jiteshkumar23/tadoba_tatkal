...
public class TatkalBooking_DataProfile1 extends BaseClassMethods {
	...
	// Set Zone here , valid values are "Moharli Zone (Core)" , "Pangadi and Zari Zone (Core)"
	public static String zoneFromData = "Pangadi and Zari Zone (Core)";

	// Set Gate here
	// For Moharli --> "Moharli"
	// For Pangadi and Zari --> "Pangadi" OR "Zari"
	public static String gateFromData = "Zari";
